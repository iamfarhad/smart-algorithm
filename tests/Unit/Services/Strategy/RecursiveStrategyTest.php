...
class RecursiveStrategyTest extends UnitTestCase
{
    private AlgorithmAbstract|null $algorithmAbstract;

    public function setUp(): void
    {
        $this->algorithmAbstract = new RecursiveStrategy();
    }

    /**
     * @throws OutOfRangeException
     */
    public function test_recursive_strategy_throw_exception_out_of_range_for_bigger_than_range(): void
    {
    ...
    public function test_recursive_strategy_throw_exception_out_of_range_for_smaller_than_range(): void
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage('The number is out of range');
     ...
     * @throws OutOfRangeException
     */
    public function test_recursive_success_result_for_data(): void
    {
     ...
     * @throws OutOfRangeException
     */
    public function test_recursive_failed_result_for_data(): void
    {
        $data = [30, 2, 8];
