...
class RecursiveStrategy extends AlgorithmAbstract
{
    ...
    public function doAlgorithm(int $number): int
    {
        ...
        return $this->getSumOfSeparatedNumber($this->doAlgorithm($number - 1)) + $this->getSumOfSeparatedNumber($this->doAlgorithm($number - 2));
    }
}
